...
public class AccountDTO implements Serializable {
    ...
    public AccountDTO(Account a) {
        ...
        dateLastUpdated = a.getDateLastUpdated();
        currentBalance = a.getCurrentBalance();
        totalAccountAmount = a.getTotalAccountAmount();
        cashAfterAccount = a.getCashAfterAccount();
        customerNumber = a.getCustomerNumber();
        customerAccountName = a.getCustomerAccountName();
        customerAccountNumber = a.getCustomerAccountNumber();
        customerIdentityNumber = a.getCustomerIdentityNumber();
        propertyAddress = a.getPropertyAddress();
        lastBillAmount = a.getLastBillAmount();
        nextBillDate = a.getNextBillDate();
        currentArrears = a.getCurrentArrears();
        billDay = a.getBillDay();
        previousBillDate = a.getPreviousBillDate();
