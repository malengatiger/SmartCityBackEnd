...
public class ComplaintUpdateStatusDTO implements Serializable {
    ...
    public ComplaintUpdateStatusDTO(ComplaintUpdateStatus a) {
        this.complaintUpdateStatusID = a.getComplaintUpdateStatusID();
        this.dateUpdated = a.getDateUpdated();
        this.resolvedFlag = a.getResolvedFlag();
        customerComment = a.getCustomerComment();
        complaintID = a.getComplaint().getComplaintID();
        remarks = a.getRemarks();
        customerComment = a.getCustomerComment();
        customerOKFlag = a.getCustomerOKFlag();
