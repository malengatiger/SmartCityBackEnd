...
public class RequestDTO {
    ...
    //register
    public static final int REGISTER_MUNICIPALITY = 1,
            REGISTER_MUNICIPALITY_STAFF = 2,
            REGISTER_CITIZEN = 3;

    //sign-in
    public static final int SIGN_IN_MUNICIPALITY_STAFF = 4,
            SIGN_IN_CITIZEN = 5;

    //Create new data
    public static final int ADD_CITIES = 100,
    ...
    //Update data
    public static final int UPDATE_CITY = 1100,
